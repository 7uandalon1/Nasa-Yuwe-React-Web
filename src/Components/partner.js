...
import { BsFacebook, BsInstagram, BsTwitter, BsLinkedin, BsArrowBarDown} from 'react-icons/bs';
    ...
    return(
        <div className='partner' id={props.id}>
            ...
            <div className="partner-social-media">
                ...
                <a href={props.linkedin}><BsLinkedin></BsLinkedin></a>
            </div>
            <div>
                <Link type='button' offset={0} className='goDown' duration={250} smooth={false} to={props.to}>
